  ...
  return (
    ...
    <div className="container-fluid">
        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
            <Link className="nav-link" to="/about">{props.aboutchange}</Link>
            </li>
        </ul>
        ...
        <div className={`form-check form-switch mx-4 text-${props.modeValue === 'light'?'dark' : 'light'}`}>
...
Navbar.propTypes = {
    ...
    aboutchange: PropTypes.string.isRequired
}

Navbar.defaultProps = {
    title: 'Set title here default',
    aboutchange: 'About text here default'
}